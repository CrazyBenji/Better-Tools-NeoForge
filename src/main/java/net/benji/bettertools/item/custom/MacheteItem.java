...
public class MacheteItem extends DiggerItem implements VeinMiningTool {
    ...
    public MacheteItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties, int maxBlocks) {
    ...
    public MacheteItem(Tier tier, Properties properties, int maxBlocks) {
        this(tier, 2.0F, -2.8F, properties, maxBlocks);
    }
