...
public class BetterToolsItemTagProvider extends VanillaItemTagsProvider {
    public BetterToolsItemTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
